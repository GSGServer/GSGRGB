...
const savedColors = ['FFB800', 'FF156A', getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor(), getRandomHexColor()];
const presets = {
  0: {
    colors: ["EBFF01", "FFB341", "EBFF01"],
    text: "gsgserver.com.br"
  },
  1: {
...
function updateOutputText(event) {
  ...
  if (format.outputPrefix) {
    ...
    if (nickName.value) {
      ...
      if (!nickName.value.match(letters)) nickName.value = 'GSGServer';
    }
  }
